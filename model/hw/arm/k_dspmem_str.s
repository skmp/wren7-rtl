@ k_dspmem_str.s -- ARM wave RAM timing while the DSP accesses wave RAM: the prologue copies a DSP program (image at
@ 0x20000) into MPRO, sets MADRS[0] = 0 and RBP = 0x1C0000 (RBL 0), then 16 x "str r0, [r3]" per iteration, ITER times.
